<div style="padding-right: 0px" class="right_sidebar col-md-3-right col-sm-3 col-xs-12">
    ...
    <div class=" noidung_tk_tt col-md-12">
        ...
        <div class="checkbox_right_tt">
            ...
            <label style="margin-right:16px " for="ve-khu-hoi"><span>

            </span>{vekhuhoi_td}</label><input type="radio" name="RoundTrip" value="false"
                                            id="ve-mot-chieu"><label
                    for="ve-mot-chieu"><span></span>{vemotchieu_td}</label>
        </div>
